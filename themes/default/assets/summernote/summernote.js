  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      fontname: function (lang, options) {
        ...
        var defaultFontName = realFontList[0];
      ...
      paragraph: function (lang, options) {
        ...
        var dropdown = [
          ...
          '</div><br /><div class="note-list btn-group" style="margin-top: 5px;">',
