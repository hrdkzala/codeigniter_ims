...
<!--[if lt IE 9]>
  ...
  var base_url = '<?= base_url(); ?>', js_date = '<?= $dateFormats['js_sdate']; ?>', thousands_sep = '<?=$Settings->thousands_sep;?>', decimals_sep = '<?=$Settings->decimals_sep;?>', decimals = <?=$Settings->decimals;?>;
  </script>
</head>
...
<div class="navbar navbar-inverse bs-docs-nav" role="banner">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="<?= base_url(); ?>" class="navbar-brand" style="padding:15px; font-size:20px; text-transform:uppercase;"><i class="fa fa-file-text"></i> <?= $Settings->site_name; ?><!--<img src="<?= $assets; ?>img/<?= $Settings->logo; ?>" alt="<?= $Settings->site_name; ?>" />--></a> </div>
    <?php /*<ul class="nav navbar-nav visible-lg visible-md">	
     ...
     <?php  if (DEMO) {
        ...
        <li class="dropdown dropdown-big"> <a class="dropdown-toggle" href="#" data-toggle="dropdown"> <i class="fa fa-list"></i> <?= lang('events'); ?> </a>
          <ul class="dropdown-menu">
             ...
             <li><strong><?= $this->sim->hrsd($event->date).':</strong> '.$event->data; ?></span><div class="clearfix"></div><hr /></li>
          <?php } } else { ?>
...
<div class="sidebar">
  ...
  <div class="sidebar-inner">
    <ul class="navi">
      ...
      </li>            <li class="has_submenu nblue"> <a class="mm_category" href="#"> <i class="fa fa-tags"></i> <?= lang('category'); ?> <span class="pull-right"><b class="fa fa-sort-down"></b></span> </a>        <ul>          <li><a id="category_index" href="<?= site_url('category'); ?>"><?= lang('list_category'); ?></a></li>          <li><a id="category_add" href="<?= site_url('category/add'); ?>"><?= lang('add_category'); ?></a></li>        </ul>      </li>
      ...
      <li class="has_submenu norange"> <a class="mm_settings" href="#"> <i class="fa fa-cog"></i> <?= lang('settings'); ?> <span class="pull-right"><b class="fa fa-sort-down"></b></span> </a>
        <ul>
          ...
          <li><a id="settings_skrill" href="<?= site_url('settings/skrill'); ?>"><?= lang('skrill_settings'); ?></a></li>                    <?php /*<li><a id="settings_mollie" href="<?= site_url('settings/mollie'); ?>"><?= lang('mollie_settings'); ?></a></li>*/ ?>
          ...
          <li class="divider"></li>
          <?php /*<li><a href="<?= site_url('settings/backups'); ?>"><?= lang('backups'); ?></a></li>
    ...
    <?php /*<div class="sidebar-widget" style="text-align:center; letter-spacing:2px; color:#666; text-transform:uppercase;"> <?= $Settings->site_name.' v'.$Settings->version; ?> </div>*/ ?>
  </div>
</div>
<div class="mainbar">
