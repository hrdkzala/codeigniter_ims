      ...
      <div class="navbar-header">
        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
          <ul class="nav navbar-nav navbar-right" style="margin-right:0px; padding: 0 0 0 15px;">
           ...
           <li class="nred"><a id="index" href="<?= site_url('clients'); ?>"><i class="fa fa-dashboard"></i> <?= lang('dashboard'); ?></a></li>
           <li class="nblue"><a id="sales" href="<?= site_url('clients/sales'); ?>"><i class="fa fa-file-text"></i> <?= lang('invoices'); ?></a></li>
           <li class="nviolet"><a id="quotes" href="<?= site_url('clients/quotes'); ?>"><i class="fa fa-file-text-o"></i> <?= lang('quotes'); ?></a></li>
           <li class="norange"><a id="company_details" href="<?= site_url('clients/company_details'); ?>"><i class="fa fa-building-o"></i> <?= lang('company_details'); ?></a></li>
           <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="fa fa-user"></i> Hi, <?= $this->session->userdata('username'); ?> <b class="caret"></b> </a>
            <ul class="dropdown-menu">
              <li><a href="<?= site_url('clients/change_password'); ?>"><i class="fa fa-key"></i> <?= lang('change_password'); ?></a></li>
