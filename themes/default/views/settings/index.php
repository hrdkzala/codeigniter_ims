...
<div class="matter">
    <div class="container">
        ...
        <div class="col-md-4"><div class="form-group">
                ...
                <div class="controls">
                    <?php
                    $lang = array ('default' => 'Default');
                    echo form_dropdown('theme', $lang, $Settings->theme, 'class="form-control" id="theme"'); ?>
                </div>
            </div></div>
        <div class="col-md-4"><div class="form-group">
        ...
        <div class="col-md-4"><div class="form-group">
                ...
                <div class="controls">
                    ...
                    echo form_dropdown('date_format', $dt, $Settings->dateformat, 'class="form-control tip chzn-select" data-placeholder="'.lang("select").' '.lang("date_format").'" required="required" data-error="'.lang("date_format").' '.lang("is_required").'"'); ?>
                </div>
            </div></div>
        ...
        <div class="col-md-4"><div class="form-group">
                <label for="total_rows"><?= lang("total_rows"); ?></label>
                <div class="controls"> <?= form_input('total_rows', $Settings->total_rows, 'class="form-control" id="total_rows"');?> </div>
            </div></div>
