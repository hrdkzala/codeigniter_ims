...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('change', '.quantity', function() {
            calculateTotal();
        });        $('#gen_ref').parent('.input-group').children('input').val(getRandomRef());
        calculateTotal();
        ...
        $("#addButton").click(function () {
            ...
            newTr.html('<td style="width: 20px; text-align: center; padding-right: 10px;">'+ counter +'</td><td><input type="text" class="quantity form-control input-sm" name="quantity' + counter +
            '" id="quantity' + counter + '" value="" style="min-width: 70px; text-align: center;" /></td><td><input type="text" name="product' + counter +
            '" id="product' + counter + '" value="" class="form-control input-sm" /></td><?php if($Settings->default_tax_rate) { ?><td><select class="tax form-control input-sm" style="min-width: 100px;" name="tax_rate' + counter + '" id="tax_rate' + counter + '"><?php
		...
		?></select></td><?php } ?><td><input type="text" name="unit_price' + counter +
            '" id="price-' + counter + '" value="" class="price form-control input-sm text-right" style="min-width: 100px;"></td>');
    ...
    $( "#date, #due_date" ).datepicker("setDate", new Date());
...
<div class="matter">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="controls"> <?= form_input('due_date', (isset($_POST['due_date']) ? $_POST['due_date'] : ""), 'class="form-control" id="due_date"');?> </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls"> <?php
                        ...
                        echo form_dropdown('recurring', $opt, (isset($_POST['recurring']) ? $_POST['recurring'] : ""), 'class="form-control" id="recurring"');?> </div>
                </div>
        ...
        <table id="dyTable" class="table table-striped" style="margin-bottom:5px;">
            ...
            for($r=1; $r<=$Settings->no_of_rows; $r++) {
                ...
                <tr id="line<?= $r; ?>">
                    ...
                    <?php if($Settings->default_tax_rate) { ?>
						<td><?php
                        echo form_dropdown('tax_rate'.$r, $tr, $tr_value, 'id="tax_rate0'.$r.'" class="tax form-control input-sm" style="min-width: 100px;"');  ?></td>
						</th><?php } ?>
        ...
        <div class="form-group"> <?= form_submit('submit', lang("add_sale"), 'class="btn btn-primary btn-large"');?> </div>
        <?= form_close();?>
        <div class="clearfix"></div>
    </div>
    <div class="clearfix"></div>
