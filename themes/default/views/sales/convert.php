...
<div class="page-head">
	<h2 class="pull-left"><?= $page_title." ".lang("no")." ".$id ?> <span class="page-meta"><?= lang("update_info"); ?></span> </h2>
</div>
			...
			<div class="col-md-5">
				...
				<table id="dyTable" class="table table-striped" style="margin-bottom:5px;">
					...
					<tbody>
						...
						<div class="form-group"> <?= form_submit('submit', lang("submit"), 'class="btn btn-primary btn-large"');?> </div>
						<?= form_close();?>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
